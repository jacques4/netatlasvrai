...
namespace FriendlyRS1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task SendConfirmationToken(ApplicationUser user, string action, bool tokenType = true)
        {
            ...
            await _emailSender.SendEmailAsync(user.Email, "Social Platform NET_ATLAS",
                callbackUrl, msg);
        }
